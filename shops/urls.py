...
from shops.views import ajax_sell_item, ShopCreateView, ShopDetailView, ShopUpdateView, ShopDeleteView, buy_item_from_shop, \
...
urlpatterns = [
    ...
    path("shops/<int:pk>/delete/", ShopDeleteView.as_view(), name="shop-delete"),
