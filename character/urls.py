...
from .views import CharacterCreateView, CharacterDetailView, CharacterInventoryView, \
    UnequipSlotView, EquipItemView, DropItemView, LevelUpView, CharacterUpdateView, ChestDetailView
...
urlpatterns = [
    ...
    path("<int:pk>/", CharacterDetailView.as_view(), name="character_detail"),    # Обработчик выбора конкретного сундука:
